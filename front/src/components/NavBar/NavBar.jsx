        ...
        >
          <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-blue-600 md:flex-row md:space-x-8 md:mt-0 md:border-0 ">
            ...
            <li>
              <a
                href="/como-funciona"
                className="text-white ml- bg-orange-500 hover:bg-orange-600 focus:outline-none focus:ring-4 focus:ring-red-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900"
              >
                Llamar al 0800
              </a>
            </li>
